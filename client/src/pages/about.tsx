      ...
      <div className="container mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="prose prose-lg max-w-none font-montserrat text-foreground/80 dark:text-slate-300">
              <p>
              ...
              <blockquote className="font-cormorant text-xl italic border-l-4 border-primary pl-4 dark:text-slate-200">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-montserrat text-lg text-foreground/80 dark:text-slate-300 max-w-3xl mx-auto mb-8">
