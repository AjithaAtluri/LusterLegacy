...
export default function AddProduct() {
  ...
  return (
    <AdminLayout title={editMode ? "Edit Product" : "Add Product"}>
      <div className="container p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-semibold">{editMode ? "Edit Product" : "Add New Product"}</h1>
          </div>
          ...
          <div className="w-full space-y-8">
            ...
            <div className="border-b pb-2 pt-6">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Upload images and fill in details to generate product content using AI
              </p>
            </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div
                      ...
                      className={`border-2 border-dashed rounded-lg p-4 text-center cursor-pointer hover:bg-primary/5 transition-colors h-[100px] flex flex-col items-center justify-center mb-2 ${additionalImageFiles.length >= 3 ? 'opacity-50' : ''}`}
                    >
