...
// Updated product pages with unified AI generator
const AdminAddProduct = lazy(() => import("@/pages/admin/updated-add-product"));
const AdminEditProduct = lazy(() => import("@/pages/admin/updated-edit-product"));
